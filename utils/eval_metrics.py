...
class pb_mse_metric_test(nn.Module):
    ...
    def forward(self,target,prediction,filename,params,name):
        ...
        stats_df.loc[stats_df["image"]==filename,"T4x"] = lm_pred[0,0]
        stats_df.loc[stats_df["image"]==filename,"T4y"] = lm_pred[0,1]
        stats_df.loc[stats_df["image"]==filename,"T4_val"] = max_val[0]
        stats_df.loc[stats_df["image"]==filename,"T5x"] = lm_pred[1,0]
        stats_df.loc[stats_df["image"]==filename,"T5y"] = lm_pred[1,1]
        stats_df.loc[stats_df["image"]==filename,"T5_val"] = max_val[1]
        stats_df.loc[stats_df["image"]==filename,"T6x"] = lm_pred[2,0]
        stats_df.loc[stats_df["image"]==filename,"T6y"] = lm_pred[2,1]
        stats_df.loc[stats_df["image"]==filename,"T6_val"] = max_val[2]
        stats_df.loc[stats_df["image"]==filename,"T7x"] = lm_pred[3,0]
        stats_df.loc[stats_df["image"]==filename,"T7y"] = lm_pred[3,1]
        stats_df.loc[stats_df["image"]==filename,"T7_val"] = max_val[3]
        stats_df.loc[stats_df["image"]==filename,"T8x"] = lm_pred[4,0]
        stats_df.loc[stats_df["image"]==filename,"T8y"] = lm_pred[4,1]
        stats_df.loc[stats_df["image"]==filename,"T8_val"] = max_val[4]
        stats_df.loc[stats_df["image"]==filename,"T9x"] = lm_pred[5,0]
        stats_df.loc[stats_df["image"]==filename,"T9y"] = lm_pred[5,1]
        stats_df.loc[stats_df["image"]==filename,"T9_val"] = max_val[5]
        stats_df.loc[stats_df["image"]==filename,"T10x"] = lm_pred[6,0]
        stats_df.loc[stats_df["image"]==filename,"T10y"] = lm_pred[6,1]
        stats_df.loc[stats_df["image"]==filename,"T10_val"] = max_val[6]
        stats_df.loc[stats_df["image"]==filename,"T11x"] = lm_pred[7,0]
        stats_df.loc[stats_df["image"]==filename,"T11y"] = lm_pred[7,1]
        stats_df.loc[stats_df["image"]==filename,"T11_val"] = max_val[7]
        stats_df.loc[stats_df["image"]==filename,"T12x"] = lm_pred[8,0]
        stats_df.loc[stats_df["image"]==filename,"T12y"] = lm_pred[8,1]
        stats_df.loc[stats_df["image"]==filename,"T12_val"] = max_val[8]
        stats_df.loc[stats_df["image"]==filename,"L1x"] = lm_pred[9,0]
        stats_df.loc[stats_df["image"]==filename,"L1y"] = lm_pred[9,1]
        stats_df.loc[stats_df["image"]==filename,"L1_val"] = max_val[9]
        stats_df.loc[stats_df["image"]==filename,"L2x"] = lm_pred[10,0]
        stats_df.loc[stats_df["image"]==filename,"L2y"] = lm_pred[10,1]
        stats_df.loc[stats_df["image"]==filename,"L2_val"] = max_val[10]
        stats_df.loc[stats_df["image"]==filename,"L3x"] = lm_pred[11,0]
        stats_df.loc[stats_df["image"]==filename,"L3y"] = lm_pred[11,1]
        stats_df.loc[stats_df["image"]==filename,"L3_val"] = max_val[11]
        stats_df.loc[stats_df["image"]==filename,"L4x"] = lm_pred[12,0]
        stats_df.loc[stats_df["image"]==filename,"L4y"] = lm_pred[12,1]
        stats_df.loc[stats_df["image"]==filename,"L4_val"] = max_val[12]
